...
export const leadContent = {
    ...
    paragraph: `${schoolName} offers programs in Full-Stack Web Development and Data Science to provide students with a foundation for a career in tech. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKBTWDO18",
    ...
    },
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKBTDSO18",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 15900,
            loanTerm36: true,
            loanTerm60: true,
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $15,900 for Full-Stack Web Development or Data Science tuition."
