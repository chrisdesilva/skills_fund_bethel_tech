...
export const leadContent = {
  ...
  paragraph: `${schoolName} offers programs in Full-Stack Web Development and Data Science to provide students with a foundation for a career in tech. ${schoolName} partners with Skills Fund to offer tuition${
...
export const threeStepCardText = {
  ...
  step2: {
    ...
    text:
      "Choose between the Full-Stack Web Development Online and Data Science Online programs.",
  },
